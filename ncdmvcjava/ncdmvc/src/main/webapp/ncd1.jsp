...
<body>
  ...
  <table border="1" cellspacing="0">
    ...
    <td>Enter Number:<input type="number" min="0" max="3" name="age"align="center" required></td>
    ...
    <th>0</br> 1</br> 2 </th>
    <td>Enter Number:<input type="number" min="0" max="2" name="smoke"align="center" required></td>
    ...
    <th>yes<br>No</th>
    <th>0</br> 1 </th>
    <td>Enter Number:<input type="number"min="0" max="1"name="alcohol" align="center" required></td>
    ...
    <td colspan="1"></td>
    <td rowspan="4">Enter Number:<input type="number"min="0" max="2"name="measurement" align="center" required></td>
    ...
    <th>0</br> 1 </th>
    <td>Enter  Number:<input type="number"min="0" max="1"name="physical" align="center" required></td>
    ...
    <th>0</br> 2 </th>
    <td>Enter Number:<input type="number"min="0" max="2" step = 2 name="history" align="center" required></td>
